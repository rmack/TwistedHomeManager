...
public class StaticConfig
{
    ...
    public static final String      ActionLauncher              = "market://details?id=com.actionlauncher.playstore";
    public static final String      ActionLauncherName          = "Action Launcher";
    ...
    public static final String      BIGLauncher                 = "market://details?id=name.kunes.android.launcher.demo";
    public static final String      BIGLauncherName             = "BIG Launcher";
    ...
    public static final String      POCOLauncherName            = "POCO Launcher";
    ...
    public static final String      ZeamLauncher                = "market://details?id=org.zeam";
